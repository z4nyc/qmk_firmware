...
[_ES_LA] = LAYOUT(
         ...
         KC_LCTL,           ES_Z,        ES_X,         ES_C,       ES_V,          ES_B, KC_MPLY,    KC_MUTE,             ES_N,       ES_M,       ES_COMM,       ES_DOT,    ES_MINS,  KC_RCTL,
                                      KC_LGUI,      KC_LALT,    KC_LALT,    MO(_LOWER),  KC_SPC,     KC_ENT, MO(_RAISE_ES_LA),    KC_RALT,       KC_RALT,       KC_MENU
),
...
[_EN_US] = LAYOUT(
          ...
          KC_TAB,         KC_Q,          KC_W,         KC_E,       KC_R,          KC_T,                                  KC_Y,       KC_U,          KC_I,         KC_O,       KC_P,  UUSST_KC_ACUT,
         KC_CAPS,         KC_A,          KC_S,         KC_D,       KC_F,          KC_G,                                  KC_H,       KC_J,          KC_K,         KC_L,       KC_N,  USSUT_KC_LCBR,
         KC_LSFT,         KC_Z,          KC_X,         KC_C,       KC_V,          KC_B, KC_MPLY,    KC_MUTE,             KC_N,       KC_M, UUSUT_KC_COMM, UUSST_KC_DOT,    KC_MINS,  KC_RSFT,
                                      KC_LGUI,      KC_LALT,    KC_LALT,    MO(_LOWER),  KC_SPC,     KC_ENT, MO(_RAISE_EN_US),    KC_RALT,       KC_RALT,      KC_MENU
),
...
[_NUMPAD] = LAYOUT(
 _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         LAYER_KC_NUMPAD_CALLER, KC_PSLS, KC_PAST, KC_PMNS, XXXXXXX, UUSUT_KC_BSDL,
 _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                          KC_P7,   KC_P8,   KC_P9, KC_PPLS, XXXXXXX, KC_DEL,
 _______,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                          KC_P4,   KC_P5,   KC_P6, KC_PPLS, XXXXXXX, XXXXXXX,
 _______,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   KC_MPLY,    KC_MUTE,   KC_P1,   KC_P2,   KC_P3, KC_PENT, XXXXXXX, KC_RSFT,
...
[_RAISE_EN_US] = LAYOUT(
  ...
  _______, USSST_KC_LABK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  _______,      _______,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX,
                        _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      | ES-LA|      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | QK_BOOT|    | EN-US|      |MACWIN|      |                    |      |      | M_UP |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |MACWIN|      |      |      |-------.    ,-------|      |M_LEFT|M_MIDB|M_RGHT|      |      |
 * |------+------+------+------+------+------| MPLAY |    |  MUTE |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |M_LFTB| M_DN |M_RGHB|      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE | RCTR | RAlt | RGUI |
 ...
 */
  ...
  QK_BOOT, XXXXXXX, LAYER_KC_EN_US, XXXXXXX, CG_TOGG, XXXXXXX,                        XXXXXXX, XXXXXXX, KC_MS_U, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, CG_TOGG       , XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX, KC_MS_L, KC_BTN3, KC_MS_R, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX       , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX, XXXXXXX, KC_BTN1, KC_MS_D, KC_BTN2, XXXXXXX, XXXXXXX,
                           _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
  )
};
