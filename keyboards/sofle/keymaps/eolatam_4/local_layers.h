...
[_ES_LA] = LAYOUT(
    ...
    KC_LCTL,     ES_Z,     ES_X,     ES_C,     ES_V,       ES_B, KC_MPLY,    KC_MUTE,             ES_N,     ES_M,  ES_COMM,   ES_DOT,  ES_MINS,  KC_RCTL,
                        KC_LGUI,  KC_LALT,  KC_BTN3, MO(_LOWER),  KC_SPC,     KC_ENT, MO(_RAISE_ES_LA),   KC_TAB,  KC_RALT,  KC_RGUI
),
...
[_EN_US] = LAYOUT(
    ...
    KC_LCTL,     KC_Z,     KC_X,     KC_C,     KC_V,       KC_B, KC_MPLY,    KC_MUTE,             KC_N,     KC_M,  KC_COMM,   KC_DOT,  KC_MINS,  KC_RCTL,
                        KC_LGUI,  KC_LALT,  KC_BTN3, MO(_LOWER),  KC_SPC,     KC_ENT, MO(_RAISE_EN_US),   KC_TAB,  KC_RALT,  KC_RGUI
),
...
[_RAISE_EN_US] = LAYOUT(
    ...
    _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,                                KC_DEL,  KC_LEFT,  KC_DOWN,  KC_RGHT, BA_LCBR,  BA_RCBR,
    _______,  BB_LABK,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX, _______,     _______,         XXXXXXX,  KC_HOME,  XXXXXXX,   KC_END, XXXXXXX,  XXXXXXX,
                        _______,  _______,  _______,    _______, _______,    KC_RALT,          _______,  KC_RALT,  _______,  _______
),
